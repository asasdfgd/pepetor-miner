...
open(F, "/Users/josephpietravalle/PEPETOR-MINER/tor-0.4.8.19/src/app/tor --list-torrc-options |") or die;
while (<F>) {
...
loadTorrc("/Users/josephpietravalle/PEPETOR-MINER/tor-0.4.8.19/src/config/torrc.sample.in", \%torrcSampleOptions);

# Try to figure out what's in the man page.

my $considerNextLine = 0;
open(F, "/Users/josephpietravalle/PEPETOR-MINER/tor-0.4.8.19/doc/man/tor.1.txt") or die;
while (<F>) {
